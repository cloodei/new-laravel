                ...
                <div class="w-64">
                    <div class="relative group h-64 rounded-lg overflow-hidden bg-gray-800 shadow-lg">
                        ...
                        >
                            ...
                            <form action="{{ route('favorite.remove', $favorite->content->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to remove this movie from your favorites?')" class="inline">
                                @csrf
                                @method('DELETE')
