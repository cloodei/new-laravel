                    ...
                    <div class="relative group movies-bg h-[80vh] rounded-b-lg overflow-hidden">
                        ...
                        <div class="absolute lg:bottom-6 bottom-4 lg:left-12 left-6">
                            ...
                            <div class="flex mt-6 gap-1">
                                ...
                                <form action="{{ route('favorite.add', $movieBanner['id']) }}" method="POST" class="inline">
                                    @csrf
                                    <button type="submit" class="ml-4 px-[14px] pb-2 pt-[9px] rounded-full font-semibold transition-all duration-[250ms] like-btn 
                                        {{ $favorites->contains($movieBanner['id']) ? 'text-rose-500 border-red-500' : 'text-gray-400 hover:text-white hover:border-rose-500' }} 
