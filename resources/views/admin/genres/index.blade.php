...
<div class="bg-gray-800 p-4 pb-7 rounded-lg border border-gray-600">
    <div class="flex justify-end items-center mb-4">
        <a href="genres/create" class="bg-blue-600 hover:bg-blue-800 text-gray-100 transition font-bold py-[6px] px-4 rounded-lg">
        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-700">
                    ...
                    <td class="p-2">
                        <a href="{{route('genres.edit', [$item->id])}}" class="text-blue-400 hover:text-blue-800 transition">
