...
<div class="bg-gray-800 p-4 pb-7 rounded-lg border border-gray-600">
    <div class="flex justify-between items-center mb-4">
        <input type="search" placeholder="Search shows..." class="max-w-sm md:max-w-md lg:max-w-lg bg-gray-700 border border-slate-500 text-white p-2 pl-3 rounded-md placeholder-slate-200">
        ...
        <table class="w-full">
            ...
            <tbody>
                <tr class="border-b border-gray-700">
                    <td class="p-2">Teen Titans</td>
                    <td class="p-2">Cartoon</td>
                    <td class="p-2">10</td>
                    <td class="p-2">
