        ...
        <div class="bg-gray-800 p-4 rounded-lg h-fit flex-1 border border-slate-500">
            ...
            <form action="{{route('categories.store')}}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input id="slug" name="name" value="{{old('name')}}" onkeyup="ChangeToSlug();" class="bg-gray-700 mt-[10px] border border-gray-400 text-gray-100 p-2 rounded-md w-full">
                </div>
                <div class="mb-4">
                    <label for="categorySlug" class="block text-sm font-medium text-gray-300">Slug</label> 
                    <input id="convert_slug" name="slug" value="{{old('slug')}}" class="bg-gray-700 mt-[10px] border border-gray-400 text-gray-100 p-2 rounded-md w-full">
                </div>
                <div class="mb-6">
                    <label for="categoryDescription" class="block text-sm font-medium text-gray-300">Description</label>
                    <input id="categoryDescription" name="description" value="{{old('description')}}" class="bg-gray-700 mt-[10px] border border-gray-400 text-gray-100 p-2 rounded-md w-full">
                </div>
